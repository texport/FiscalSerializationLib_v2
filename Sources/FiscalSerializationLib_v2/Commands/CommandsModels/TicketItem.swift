...
public struct TicketItem {
    ...
    public let nameTicketItem: String
    /// -------------------------------------------------------------------------------------------
    ...
    public let measureUnitCode: UnitOfMeasurement
    /// -------------------------------------------------------------------------------------------

    /// -------------------------------------------------------------------------------------------
    /// ЦЕНА ОДНОЙ ЕДЕНИЦЫ ТОВАРА/РАБОТЫ/УСЛУГИ
    /// billsPrice и coinsPrice - это тенге и тиыны
    public let billsPrice: UInt64
    public let coinsPrice: UInt32
    /// -------------------------------------------------------------------------------------------
    ...
    public let isTicketItemTax: Bool
    ...
    public let isTicketItemDiscount: Bool
